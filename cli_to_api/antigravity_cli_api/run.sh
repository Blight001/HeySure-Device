...
print_heysure_config() {
  ...
  echo "会话模式：按 HeySure 会话本地续接；超长上下文通过临时文件传递"
...
run_as_service_user() {
  ...
  forwarded=(
    ...
    "ANTIGRAVITY_CLI_ARG_SAFE_BYTES=$ANTIGRAVITY_CLI_ARG_SAFE_BYTES"
    "ANTIGRAVITY_CLI_SESSIONS_DIR=$ANTIGRAVITY_CLI_SESSIONS_DIR"
